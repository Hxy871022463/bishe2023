<template>
    <div>
        <div style="margin: 10px 0">
            ...
            <!--            <el-input style="width: 200px" placeholder="请输入地址" suffix-icon="el-icon-location" class="ml-5"></el-input>-->
        ...
        <el-dialog title="用户信息" :visible.sync="dialogFormVisible" width="30%" :close-on-click-modal="false" :before-close="beforeClose">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="save" v-if="addBtnVisible">确 定</el-button>
                <el-button type="primary" @click="edit" v-if="editBtnVisible">保 存</el-button>
            </div>
        </el-dialog>
